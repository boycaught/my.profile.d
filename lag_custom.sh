...
GOROOT="$BREW_HOME/Cellar/go/1.2.1"
GOPATH="$HOME/go"
GRADLE_HOME="$BREW_HOME/Cellar/gradle/1.11"
...
JRUBY_HOME="$BREW_HOME/Cellar/jruby/1.7.11"
JYTHON_HOME="$MY_HOME/jython"
M2_HOME="$MY_HOME/maven"
MAVEN_OPTS="-Xms256m -Xmx512m"
MYSQL_HOME="$BREW_HOME/Cellar/mysql"
MONGODB_HOME="$BREW_HOME/Cellar/mongodb/2.4.9"
NGINX_HOME="$BREW_HOME/Cellar/nginx/1.4.6"
